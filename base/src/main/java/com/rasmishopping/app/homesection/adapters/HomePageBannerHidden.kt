...
class HomePageBannerHidden(fm: FragmentManager, var context: Context, var items: ArrayList<MageBanner>, private var type: String, private var cornerradius: Float, private var marginbanner:Int) :
    PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        params.marginStart= (value * 2).toInt()
        params.marginEnd= (value * 2).toInt()
        var view:View?=null
        when(type){
            "topbarbanner"->{

package com.rasmishopping.app.addresssection.viewmodels
...
class AddressModel(private val repository: Repository) : ViewModel() {
    ...
    private fun getAddressList() {
        try {
            ...
            doGraphQLQueryGraph(
                repository,
                Query.getAddressList(data!!.customerAccessToken, addresscursor),
    ...
    fun deleteAddress(msg: String, adress: Address) {
        try {
            ...
            doGraphQLMutateGraph(
                repository,
                (MutationQuery.deleteCustomerAddress(
    ...
    fun addAddress(input: Storefront.MailingAddressInput) {
        try {
            doGraphQLMutateGraph(
                repository,
                MutationQuery.addAddress(input, data!!.customerAccessToken),
                customResponse = object : CustomResponse {
                    override fun onSuccessMutate(result: GraphCallResult<Storefront.Mutation>) {
    ...
    fun updateAddress(input: Storefront.MailingAddressInput, address_id: ID?) {
        try {
            doGraphQLMutateGraph(
                repository,
                MutationQuery.updateAddress(input, data!!.customerAccessToken, address_id),
                customResponse = object : CustomResponse {
                    override fun onSuccessMutate(result: GraphCallResult<Storefront.Mutation>) {

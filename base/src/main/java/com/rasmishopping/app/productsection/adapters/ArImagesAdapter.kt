...
import com.rasmishopping.app.databinding.ArimagesItemBinding
import com.rasmishopping.app.productsection.models.MediaModel
import com.rasmishopping.app.utils.Constant
import javax.inject.Inject

class ArImagesAdapter @Inject constructor() :
    RecyclerView.Adapter<ArImagesAdapter.ArImagesViewHolder>() {
    ...
    class ArImagesViewHolder(itemView: ArimagesItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArImagesViewHolder {
        var view = DataBindingUtil.inflate<ArimagesItemBinding>(
            LayoutInflater.from(parent.context),
            R.layout.arimages_item,
            parent,
            false
        )
    ...
    override fun onBindViewHolder(holder: ArImagesViewHolder, position: Int) {
        ...
        holder.binding.arImage.setOnClickListener {
            try {
                ...
                Toast.makeText(
                    it.context,
                    it.context.getString(R.string.ar_error_text),
                    Toast.LENGTH_SHORT
                ).show()
            }

package com.rasmishopping.app.yotporewards.getrewards.adapter
...
import com.rasmishopping.app.databinding.GetrewadsItemBinding
...
class GetRewardsAdapter @Inject constructor() :
    RecyclerView.Adapter<GetRewardsAdapter.GetRewardsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GetRewardsViewHolder {
        var view = DataBindingUtil.inflate<GetrewadsItemBinding>(
            LayoutInflater.from(parent.context),
            R.layout.getrewads_item,
            parent,
            false
        )

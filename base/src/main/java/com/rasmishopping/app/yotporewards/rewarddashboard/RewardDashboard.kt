package com.rasmishopping.app.yotporewards.rewarddashboard
...
import com.rasmishopping.app.databinding.ActivityRewardDashboardBinding
...
class RewardDashboard : NewBaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =
            DataBindingUtil.inflate(layoutInflater, R.layout.activity_reward_dashboard, group, true)
    ...
    private fun consumeDashbordReward(response: ApiResponse?) {
        if (response?.data != null) {
            ...
            binding?.pointtitle?.text =
                getString(R.string.your_point) + Response.getString("points_earned")

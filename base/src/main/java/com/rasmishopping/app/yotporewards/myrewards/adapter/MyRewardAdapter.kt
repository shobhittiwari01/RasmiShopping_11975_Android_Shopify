package com.rasmishopping.app.yotporewards.myrewards.adapter
...
import com.rasmishopping.app.databinding.MyrewardItemBinding
import com.rasmishopping.app.yotporewards.myrewards.model.HistoryItem
import javax.inject.Inject


class MyRewardAdapter @Inject constructor() :
    RecyclerView.Adapter<MyRewardAdapter.MyRewardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyRewardViewHolder {
        var view = DataBindingUtil.inflate<MyrewardItemBinding>(
            LayoutInflater.from(parent.context),
            R.layout.myreward_item,
            parent,
            false
        )

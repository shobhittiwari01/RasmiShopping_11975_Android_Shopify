package com.rasmishopping.app.yotporewards.earnrewards.adapter
...
import com.rasmishopping.app.databinding.EarnrewardItemBinding
import com.rasmishopping.app.yotporewards.earnrewards.model.EarnRewardModelItem
import javax.inject.Inject

class EarnRewardAdapter @Inject constructor() :
    RecyclerView.Adapter<EarnRewardAdapter.EarnRewardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EarnRewardViewHolder {
        var view = DataBindingUtil.inflate<EarnrewardItemBinding>(
            LayoutInflater.from(parent.context),
            R.layout.earnreward_item,
            parent,
            false
        )
